...
public class Tables {
    ...
    public static void main(String[] args) {
        try {
            ...
            //st.executeUpdate("insert into appuser (userRole,name,dob,mobileNumber,email,username,password,address) values('Admin','Admin','12-12-2003','09469463336','florenz.olarte@gmail.com','admin','admin','PH')");
